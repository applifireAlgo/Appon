...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelIcon("y2vBrXbQfX90V7mwTXO6ZIJ60NhoKl3QZbWwWnJbfQUq5DDrMS");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelHelp("y4pK1O64x9zzwBYx3zk6Yu2OoYghxZxXKMH4a1Zj41pIFmnD9Y");
        useraccesslevel.setLevelName("A4BnouFMYuAtlGYquNdq3CmSLqf4qnEvoAbHvr58r0MFNIQdBy");
        useraccesslevel.setLevelDescription("xkkMjOdbsY992ABWGRNXZmQnPSwbBuIlSmsX0l3smRKLyAgvpU");
        ...
        useraccessdomain.setDomainDescription("uIBalkhcSDnbWSLV1YRzLgNDAUK16yz4UFDgrOU6WUsNarrFND");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainHelp("WgVfvPpdswohmM2kkQxIMTMstaBd32nggiG3ufzetBsVPAKjAo");
        useraccessdomain.setDomainIcon("AK3YuxydEVEHrAsIMTtCyVBzj4vroivv6SXeEDP2hASqVPwZGW");
        useraccessdomain.setDomainName("PTocY4044Oo7iJQmumL1KAzgNMoYRHxruOIkXKfX7CYo3LF26l");
        ...
        User user = new User();
        user.setIsDeleted(1);
        user.setPasswordAlgo("OmQmFaVKKHsC2tMGNVXBgOjG3EPbN0IlFq7Q7WihMSSwSkOvsU");
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setAllowMultipleLogin(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsLocked(1);
        user.setGenTempOneTimePassword(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1466571742952l));
        user.setSessionTimeout(255);
        user.setMultiFactorAuthEnabled(1);
        user.setChangePasswordNextLogin(1);
        user.setUserAccessCode(38779);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1466571742953l));
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("tKKTbHgXXuarzwNMCcKFZ914Z5KtamCmTjBT0vcwS3wXRfIREG");
        Question question = new Question();
        question.setQuestionIcon("xklDrkpgVZIjkjsT01hf8K5ORrjBPxnfIY9HxzSiVUOMyeeGTi");
        question.setLevelid(3);
        question.setQuestionDetails("yDTDWb3eYT");
        question.setQuestion("GKbbbIxMHzUE7A9TpBGqjajEDRdV7WBtVAg6LZjp9eOGEBkJbi");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("5CAEKkzuAUcLScoxROzAobidvtQOArA6NjWZRw8jBqsz6CfpDC");
        ...
        userdata.setOneTimePassword("OqSxrlZOm8UeH1GTiCFSwZYoBeq4UFYF");
        userdata.setPassword("muwLvAFU1sasps3cjDqnFvNnTiiO0iExEh2A3mReT9044sz1qj");
        userdata.setLast5Passwords("wvQwxAauldwP97Dp7pQ9MdcbEiNg6dFHej7T7cw0pLAp2FBQnr");
        userdata.setOneTimePasswordExpiry(8);
        userdata.setOneTimePassword("NLRDZsGsSOhZ0NXjo3DrL8bT37VTuvcs");
        userdata.setPassword("2vuCylNoZK9Ytcu9nJ4VmhnowEGuLK18UTUQ7xGlJPAPP2628B");
        userdata.setLast5Passwords("iRzfAjEMpkKqu3fHDGqKn8FGYZVIsGHizoQ5GoasZvDvGHYa5V");
        userdata.setUser(user);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1466571743470l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 118866));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "7X8Q2Q8OoEiyOa7UC5jxEGYdtY8uURETtR13NqAgGdLXzWsNLXQPnhTe4zqBOhxVX"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 6859));
