...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("i8xiL3BUjOMxeXyp3h7OzD6zD6N9oGIItz58hGFUMd0UB8pXH0");
        question.setLevelid(9);
        question.setQuestionDetails("nGV3BusNp4");
        question.setQuestion("BEnofsB1u8jjYqr3bwnYto8lc0wObHXKKLIpDmvGcwDzFr2o7O");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("GHTRmVvNa0pkvXWSZ343XZExGtATvFUttvxjYDZ8aWlTPUoF1u");
            question.setLevelid(8);
            question.setVersionId(1);
            question.setQuestionDetails("st8nbe56MO");
            question.setQuestion("yOAWlXE0vVIqs20Y6eQF61D0y1bIicCPr4lFCoDiBd4adtEx0N");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "ge3irsEp2IdecHWV6ZVRyoZaRRZ9EK8fP4jtKOVxu47T2CrDOxfv4toIWhY9fYaQz"));
