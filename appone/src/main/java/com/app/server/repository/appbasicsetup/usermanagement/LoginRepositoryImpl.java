...
@Repository
@SourceCodeAuthorClass(createdBy = "aparna.sawant@algorhythm.co.in", updatedBy = "aparna.sawant@algorhythm.co.in", versionNumber = "2", comments = "Repository for Login Transaction table", complexity = Complexity.MEDIUM)
